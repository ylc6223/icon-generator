        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h2 className="text-headline-sm text-foreground mb-2">
              Drop your AI-generated icon image
            </h2>
            <p className="text-body-lg text-muted-foreground">
              Upload an icon matrix image to get started
            </p>
          </div>
          <UploadZone />
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-canvas">
        <div className="text-center">
          ...
          <p className="text-body-lg text-foreground">
            {status === 'detecting' ? 'Detecting icons...' : 'Processing...'}
          </p>
        </div>
      </div>
    );
    ...
    <div className="flex-1 flex flex-col bg-canvas overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-background">
        ...
        <div className="text-body-sm text-muted-foreground">
          {detectedIcons.filter(i => i.selected).length} / {detectedIcons.length} selected
        </div>
      </div>
